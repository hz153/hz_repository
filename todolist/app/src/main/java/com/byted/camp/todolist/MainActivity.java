...
//                        .setAction("Action", null).show();
                //startActivityForResult允许开启下一个activity并且下一个activity可以传回一个值
        ...
        notesAdapter = new NoteListAdapter(new NoteOperator() {
            ...
            public void changeNote(Note note) {
                MainActivity.this.changeNote(note);
            }
    ...
    private void changeNote(Note note){
        Intent intent = new Intent(MainActivity.this, SetContent.class);
        Log.d(TAG, "changeNote: "+note.id);
